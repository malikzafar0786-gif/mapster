...
### اگر Actions میں error آئے
- `.github/workflows/build-apk.yml` فائل repo کے **سب سے اوپر والے فولڈر** میں ہونی چاہیے۔
- `lib/main.dart` بھی repo میں موجود ہو، ورنہ build میں واضح پیغام آئے گا۔
- اب workflow کو `setup.sh` کی ضرورت نہیں، وہ صرف اپنے کمپیوٹر پر سیٹ اپ کے لیے ہے۔
